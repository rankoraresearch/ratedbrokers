 ...
 * Original content loaded from broker-content.json (generated by build-brokers.mjs).
 */
...
async function saveSection() {
  ...
  try {
    const res = await fetch('/api/admin/reviews/' + currentSlug + '/content?key=' + API_KEY + '&lang=' + CURRENT_LANG, {
      method: 'PUT',
