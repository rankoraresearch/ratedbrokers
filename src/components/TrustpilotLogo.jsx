 ...
 */
export default function TrustpilotLogo({ size = "sm", onDark = false }) {
  const cfg = {
  ...
  return (
    <span style={{ display: "inline-flex", alignItems: "center", gap: cfg.gap }}>
      ...
      <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: cfg.font, fontWeight: 700, color: onDark ? "#fff" : "#191C1F", letterSpacing: "-0.01em" }}>
        Trustpilot
      </span>
    </span>
  );
