...
function makeUmbrella({ title, metaDesc, intro }) {
  return {
    metaTitle: `${title} ${YEAR} — Expert Ranked | RatedBrokers`,
    metaDesc,
    intro: [intro],
...
SEO_CONTENT["crypto-uk"] = makeUmbrella({ title: "Best Crypto Brokers UK", metaDesc: `FCA-registered crypto brokers for UK traders in ${YEAR}. GBP deposits, regulated platforms, and tax-compliant.`, intro: "UK crypto traders should use FCA-registered platforms for regulatory protection. We ranked brokers that accept GBP deposits, comply with UK crypto regulations, and offer competitive conditions." });
SEO_CONTENT["crypto-usa"] = makeUmbrella({ title: "Best Crypto Brokers USA", metaDesc: `Best crypto platforms for US traders in ${YEAR}. SEC/CFTC compliant, USD accounts, and regulated exchanges.`, intro: "US crypto regulations are among the strictest globally. We identified brokers and exchanges that serve US clients in full regulatory compliance." });
SEO_CONTENT["crypto-australia"] = makeUmbrella({ title: "Best Crypto Brokers Australia", metaDesc: `ASIC-regulated crypto brokers for Australian traders in ${YEAR}. AUD accounts and local compliance.`, intro: "Australian crypto traders benefit from ASIC oversight. We ranked brokers with ASIC registration, AUD account support, and competitive crypto trading conditions." });
SEO_CONTENT["crypto-canada"] = makeUmbrella({ title: "Best Crypto Brokers Canada", metaDesc: `Best crypto platforms for Canadian traders in ${YEAR}. CSA-compliant, CAD accounts, and regulated.`, intro: "Canadian crypto traders should use platforms registered with provincial securities regulators. We ranked brokers accessible to Canadian residents with competitive conditions." });
SEO_CONTENT["crypto-germany"] = makeUmbrella({ title: "Best Crypto Brokers Germany", metaDesc: `BaFin-regulated crypto brokers for German traders in ${YEAR}. EUR accounts, tax reporting, and compliance.`, intro: "German crypto traders benefit from BaFin oversight and EU regulations. We ranked brokers with European licenses, EUR accounts, and crypto tax reporting support." });
