const data = {
  ...
  metaDescription: "We tested 32 AMF-registered brokers with real EUR accounts. These 10 offer the best trading conditions for French traders including FGDR protection, EUR base accounts, and ESMA-compliant leverage.",
  ...
  brokers: [
    ...
    { rank: 2, slug: "pepperstone", badge: "Best Execution", badgeColor: "#6d28d9", localCurrencyMin: "€0", verdict: "Fastest execution and tightest spreads in our test. CySEC-regulated with EU passport, fully compliant with AMF requirements.", localAdvantages: ["CySEC-regulated, AMF-registered", "EUR base account available", "0.0 pip raw spreads from €3.50/lot", "TradingView + cTrader + MT4/5", "24/5 support in French"], spreadBetting: false, localAccount: true, localRegRef: null },
