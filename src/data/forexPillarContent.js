...
const FOREX_PILLAR = {
  ...
  categoryNav: {
    ...
    byCost: [
      ...
      { label: "Zero Spread", path: "/best-zero-spread-forex-brokers" },
      { label: "Low Commission", path: "/best-low-commission-forex-brokers" },
    ...
    byAccount: [
      ...
      { label: "Micro Accounts", path: "/best-micro-account-forex-brokers" },
  ...
  countryLinks: [
    { flag: "🇬🇧", name: "United Kingdom", path: "/best-forex-brokers-uk" },
    ...
    { flag: "🇯🇵", name: "Japan", path: "/best-forex-brokers-japan" },
    { flag: "🇫🇷", name: "France", path: "/best-forex-brokers-france" },
    { flag: "🇪🇸", name: "Spain", path: "/best-forex-brokers-spain" },
    { flag: "🇮🇹", name: "Italy", path: "/best-forex-brokers-italy" },
    { flag: "🇳🇱", name: "Netherlands", path: "/best-forex-brokers-netherlands" },
    { flag: "🇸🇪", name: "Sweden", path: "/best-forex-brokers-sweden" },
    { flag: "🇳🇿", name: "New Zealand", path: "/best-forex-brokers-new-zealand" },
  ],
