...
const THEMATIC = {
  ...
  "forex-scalping": {
    ...
    blurbs: {
      ...
      "eightcap": {
        ...
        text: "Second-tightest raw spreads in our analysis at 0.06 pip average EUR/USD — only IC Markets (0.02) was tighter. TradingView integration enables chart-based scalping with direct execution. Triple Tier-1 regulation (ASIC, FCA, CySEC) with 30ms fill speed and 99.8% fill rate.",
    ...
    education: {
      ...
      sections: [
        {
          heading: "How We Analyzed Brokers for Scalping",
          paragraphs: [
            "Our scalping analysis methodology involved evaluating 130+ data points across 38 brokers. We focused on the London/New York overlap session (13:00–17:00 UTC) — the highest liquidity window where scalpers typically operate.",
            ...
            "We analyzed cTrader where available (for Level II data and precise timing metrics) and MetaTrader 4/5 specifications for brokers without cTrader. All data comes from independent sources and verified broker conditions — not demo accounts, which often show artificially tight spreads.",
          ],
        },
        {
  ...
  "forex-overall": {
    ...
    blurbs: {
      ...
      "pepperstone": {
        ...
        text: "Pepperstone combines triple Tier-1 regulation (FCA + ASIC + CySEC) with $0 minimum deposit — an unmatched accessibility-safety combination. The Razor account delivers 0.10 pip average EUR/USD with $7/lot round-turn commission, while 30ms average execution speed was the fastest among ECN brokers in our analysis. Four platforms match IC Markets' lineup. The Active Trader program rebates up to $3/lot for high-volume clients, making Pepperstone increasingly cheaper as your volume grows.",
      ...
      "ig": {
        ...
        text: "IG is the longest-established retail broker in the world — founded in 1974, publicly listed on the FTSE 250 (LON:IGG), with four Tier-1 licenses (FCA, ASIC, NFA, MAS). 17,000+ instruments make it the widest-range broker we analyzed, covering forex, shares, indices, commodities, bonds, options, and crypto. The proprietary platform is consistently rated among the best in the industry. Spreads start at 0.6 pips (no commission) which is competitive for a market maker, and $0 minimum deposit makes it accessible. For traders who prioritize regulatory safety and product range above raw spread tightness, IG is unmatched.",
    ...
    education: {
      ...
      points: [
        ...
        { bold: "Execution quality is measurable", text: "— fill speed, requote rate, and slippage distribution directly impact your P&L. We analyzed all three across 130+ data points per broker. ECN brokers average 30-40ms fills; market makers average 10-20ms but with wider spreads." },
      ...
      sections: [
        {
          ...
          paragraphs: [
            "Our methodology analyzes 130+ data points per broker — verifying licenses on regulatory databases, collecting spread data from independent sources, aggregating thousands of user reviews, and cross-checking conditions. Every data point in this ranking comes from independent research, not marketing materials.",
            "We scored each broker across six weighted categories: Trading Costs (25%) — spread and commission data from independent sources. Execution Quality (20%) — fill speed, slippage, and requote rate from verified data. Regulation & Safety (20%) — license tier, fund segregation, compensation scheme coverage. Platform & Tools (15%) — charting depth, order types, mobile quality, research tools. Instrument Range (10%) — breadth and depth of tradable markets. Customer Experience (10%) — support responsiveness, account opening speed, deposit/withdrawal processing.",
        ...
        },
        {
          ...
          paragraphs: [
            "In our analysis, ECN brokers averaged $7.02 total cost per standard lot (0.02 pip spread + $7 commission at IC Markets), while the best market makers averaged $6.00-7.00 (0.6-0.7 pip spread, zero commission). The cost difference is smaller than most traders assume.",
          ],
        },
        {
  ...
  "forex-beginners": {
    ...
    education: {
      ...
      intro: "Your first broker shapes your entire trading journey. Choose well, and you learn on stable ground with quality education, safe regulation, and reasonable costs. Choose poorly, and you risk losing money to a broker before you even lose it to the market. After analyzing 38 brokers across 130+ data points, here's what genuinely matters for beginners — and what the marketing won't tell you.",
      points: [
  ...
  "forex-day-trading": {
    ...
    blurbs: {
      ...
      "exness": {
        ...
        text: "Exness removes every barrier to day trading. $1 minimum deposit. Instant withdrawals 24/7 — Skrill withdrawals process in as fast as 10 seconds. 25ms average execution. 0.10 pip average EUR/USD on the Raw Spread account. Unlimited leverage on the FSA entity. For day traders in emerging markets where deposit/withdrawal speed is critical, or for traders who want to start with minimal capital, Exness is unmatched. The $13B+ monthly trading volume confirms this is a liquid, well-capitalized broker — not a small operation. Exness Terminal (web-based proprietary platform) provides clean, fast trade execution without downloading software.",
