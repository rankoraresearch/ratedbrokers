...
const PILL_ROWS = [
  { links: [
    { label: "Forex for Beginners", path: "/best-forex-brokers-for-beginners" },
    ...
    { label: "Forex Demo Accounts", path: "/best-forex-demo-accounts" },
    { label: "Forex Brokers USA", path: "/best-forex-brokers-usa" },
  ]},
  { links: [
    { label: "Pepperstone Review", path: "/reviews/pepperstone" },
    { label: "Scalping Brokers", path: "/best-forex-brokers-for-scalping" },
    { label: "IC Markets vs XM", path: "/compare/ic-markets-vs-xm" },
    { label: "Regulated Brokers", path: "/best-regulated-forex-brokers" },
    { label: "eToro Review", path: "/reviews/etoro" },
    { label: "Forex Brokers Australia", path: "/best-forex-brokers-australia" },
  ...
  { links: [
    { label: "Day Trading Brokers", path: "/best-forex-brokers-for-day-trading" },
    { label: "Plus500 Review", path: "/reviews/plus500" },
    { label: "Forex Brokers Canada", path: "/best-forex-brokers-canada" },
    ...
    { label: "High Leverage Brokers", path: "/best-high-leverage-forex-brokers" },
    { label: "Forex Brokers Germany", path: "/best-forex-brokers-germany" },
    { label: "Exness Review", path: "/reviews/exness" },
  ]},
  { links: [
    { label: "FP Markets Review", path: "/reviews/fp-markets" },
    { label: "Forex Brokers UAE", path: "/best-forex-brokers-uae" },
    { label: "Copy Trading Platforms", path: "/best-copy-trading-platforms" },
    { label: "Pepperstone vs IC Markets", path: "/compare/ic-markets-vs-pepperstone" },
    { label: "Forex Brokers Singapore", path: "/best-forex-brokers-singapore" },
