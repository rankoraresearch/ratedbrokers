    ...
    <div style={{ fontFamily: "'DM Sans',system-ui,sans-serif", background: "#f8f9fb", color: "#111827", minHeight: "100vh" }}>
      ...
      <section style={{ ...cn, marginBottom: 40 }}>
        <div style={{ maxWidth: 780 }}>
          ...
          <p style={{ fontSize: 19, lineHeight: 1.65, color: "#1f2937", margin: 0 }}>
            {t("hwmm.subtitle")}
          </p>
        </div>
      </section>
      ...
      <section style={{ ...cn, marginBottom: 48 }}>
        ...
        <div style={{ borderRadius: 14, border: "1px solid #e2e8f0", overflow: "hidden", background: "#fff" }}>
          ...
          <div style={{
            ...
            fontWeight: 700, fontSize: 13, color: "#1f2937", textTransform: "uppercase", letterSpacing: 0.5,
          }}>
          ...
          {allBrokers.map((b, i) => (
            <div key={i} style={{
              ...
              {!mob && <div style={{ textAlign: "center", fontSize: 13, color: "#1f2937" }}>{b.type}</div>}
            </div>
          ))}
        </div>
