      ...
      <section style={{
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", textAlign: "center" }}>
          ...
          <div style={{
            ...
            color: "#fbbf24", fontSize: 12, fontWeight: 700, letterSpacing: 0.5, marginBottom: 20,
          ...
          {[CONTENT.cfdVsSpot.cfd, CONTENT.cfdVsSpot.spot].map((side, idx) => (
            <div key={side.label} style={{
              ...
              <div style={{
                ...
                fontFamily: "Outfit", fontWeight: 700, fontSize: 14, marginBottom: 14,
              }}>{side.label}</div>
              <ul style={{ padding: "0 0 0 16px", margin: "0 0 14px" }}>
                {side.points.map((p, i) => (
                  <li key={i} style={{ fontSize: 13, lineHeight: 1.7, color: "#475569", marginBottom: 6 }}>{p}</li>
                ))}
              </ul>
              <div style={{
                padding: "10px 14px", borderRadius: 8,
                background: idx === 0 ? "#eff6ff" : "#ecfdf5",
                fontSize: 12, color: idx === 0 ? "#1e40af" : "#065f46", fontWeight: 600,
        ...
        <div style={{ display: "grid", gridTemplateColumns: mob ? "1fr" : tab ? "1fr 1fr" : "1fr 1fr", gap: 16 }}>
          {CONTENT.coinSections.map((coin) => (
            <div key={coin.coin} style={{ ...cardBg, padding: mob ? "20px" : "24px" }}>
              ...
              <p style={{ fontSize: 13, lineHeight: 1.7, color: "#64748b", marginBottom: 14 }}>{coin.desc}</p>
              <Link to={lp(coin.path)} style={{
                display: "inline-block", padding: "8px 16px", borderRadius: 8,
                background: "#f0fdf4", color: "#059669", fontWeight: 700, fontSize: 13,
        ...
        <div style={{ display: "grid", gridTemplateColumns: mob ? "1fr" : tab ? "1fr 1fr" : "1fr 1fr 1fr 1fr", gap: 16 }}>
          {CONTENT.securitySection.features.map((feat) => (
            <div key={feat.name} style={{ ...cardBg, padding: mob ? "20px" : "24px" }}>
              ...
              <h3 style={{ fontFamily: "Outfit", fontWeight: 700, fontSize: 15, marginBottom: 8 }}>{feat.name}</h3>
              <p style={{ fontSize: 13, lineHeight: 1.7, color: "#64748b", margin: 0 }}>{feat.desc}</p>
            </div>
          ))}
        </div>
      </section>
