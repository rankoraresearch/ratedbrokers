    ...
    <div style={{ fontFamily: "'DM Sans',system-ui,sans-serif", background: "#f8f9fb", minHeight: "100vh" }}>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", textAlign: "center" }}>
          ...
          <div style={{
            ...
            color: "#34d399", fontSize: 12, fontWeight: 700, letterSpacing: 0.5, marginBottom: 20,
            ...
            <div key={b.slug} style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
                <div style={{
                  ...
                  fontFamily: "'JetBrains Mono'", fontWeight: 800, fontSize: 14, color: "#fff",
                }}>#{i + 1}</div>
                <div>
          ...
          {CONTENT.introCards.map((card) => (
            <div key={card.title} style={{ ...cardBg, padding: mob ? "24px 20px" : "32px 28px" }}>
              ...
              {card.paragraphs.map((p, i) => (
                <p key={i} style={{ fontSize: 14, lineHeight: 1.8, color: "#475569", marginBottom: i < card.paragraphs.length - 1 ? 14 : 0 }}>
                  {p}
                </p>
              ))}
            </div>
          ...
          {CONTENT.howWeTest.map((step) => (
            <div key={step.step} style={{ ...cardBg, padding: mob ? "20px" : "24px", textAlign: "center" }}>
              ...
              <div style={{
                ...
                background: "#f0fdf4", color: "#059669", fontSize: 10, fontWeight: 700, marginBottom: 8,
              }}>STEP {step.step}</div>
              <h3 style={{ fontFamily: "Outfit", fontWeight: 700, fontSize: 16, marginBottom: 8 }}>{step.title}</h3>
              <p style={{ fontSize: 13, lineHeight: 1.7, color: "#64748b", margin: 0 }}>{step.desc}</p>
            </div>
          ))}
        </div>
      ...
      <section style={{ ...cn, paddingBottom: mob ? 24 : 32 }}>
        ...
        <div style={{ ...cardBg, overflow: "auto" }}>
          <table style={{
            width: "100%", borderCollapse: "collapse", fontSize: 13, minWidth: 700,
          }}>
            <thead>
                    ...
                    <td style={{ padding: "12px 14px" }}>
                      <div style={{ display: "flex", gap: 3, flexWrap: "wrap" }}>
                        ...
                        {b.B.platforms.length > 3 && (
                          <span style={{ padding: "2px 6px", borderRadius: 4, fontSize: 10, fontWeight: 600, background: "#f1f5f9", color: "#94a3b8" }}>
                            +{b.B.platforms.length - 3}
                          </span>
                        )}
                      </div>
          ...
          {[
            ...
            <div key={col.title} style={cardBg}>
              <div style={{
                ...
                fontFamily: "Outfit", fontWeight: 700, fontSize: 14, color: "#0f172a",
              }}>{col.title}</div>
      ...
      <section style={{ ...cn, paddingBottom: mob ? 24 : 32 }}>
        ...
        <div style={{ ...cardBg, padding: mob ? "24px 20px" : "32px 28px" }}>
          {CONTENT.costAnalysis.paragraphs.map((p, i) => (
            <p key={i} style={{ fontSize: 14, lineHeight: 1.8, color: "#475569", marginBottom: 14 }}>{p}</p>
          ))}
        ...
        <div style={{ display: "grid", gridTemplateColumns: mob ? "1fr" : tab ? "1fr 1fr" : "1fr 1fr 1fr", gap: 16 }}>
          {CONTENT.regulationGuide.regulators.map((reg) => (
            <div key={reg.name} style={{ ...cardBg, padding: mob ? "20px" : "24px" }}>
              ...
              <div style={{ fontSize: 13, fontWeight: 600, color: "#1e293b", marginBottom: 2 }}>{reg.fullName}</div>
              <div style={{ fontSize: 11, color: "#94a3b8", marginBottom: 8 }}>{reg.country}</div>
              <p style={{ fontSize: 13, lineHeight: 1.7, color: "#64748b", marginBottom: 8 }}>{reg.desc}</p>
              {reg.compensation && (
        ...
        <div style={{ display: "grid", gridTemplateColumns: mob ? "1fr" : tab ? "1fr 1fr" : "1fr 1fr 1fr 1fr", gap: 16 }}>
          {CONTENT.platformComparison.platforms.map((pl) => (
            <div key={pl.name} style={{ ...cardBg, padding: mob ? "20px" : "24px" }}>
              ...
              <div style={{ fontFamily: "Outfit", fontWeight: 700, fontSize: 15, marginBottom: 10 }}>{pl.name}</div>
              <div style={{ marginBottom: 8 }}>
                <div style={{ fontSize: 10, fontWeight: 700, color: "#059669", textTransform: "uppercase", marginBottom: 4 }}>Strengths</div>
                <p style={{ fontSize: 12, lineHeight: 1.6, color: "#475569", margin: 0 }}>{pl.strengths}</p>
              </div>
              <div style={{ marginBottom: 8 }}>
                <div style={{ fontSize: 10, fontWeight: 700, color: "#ef4444", textTransform: "uppercase", marginBottom: 4 }}>Weakness</div>
                <p style={{ fontSize: 12, lineHeight: 1.6, color: "#475569", margin: 0 }}>{pl.weakness}</p>
              </div>
              <div style={{
        ...
        <div style={{
          ...
          {CONTENT.countryLinks.map((c) => (
            <Link key={c.name} to={lp(c.path)} style={{
              ...
              textDecoration: "none", color: "#1e293b", fontSize: 13, fontWeight: 500,
              transition: "all 0.15s",
            }}
