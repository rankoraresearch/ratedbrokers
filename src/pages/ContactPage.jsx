...
// ============================
const CONTACT_CARDS = [
  { icon: "mail", color: "#059669", titleKey: "contact.generalTitle", descKey: "contact.generalDesc", emailKey: "contact.generalEmail" },
  { icon: "handshake", color: "#2563eb", titleKey: "contact.bizTitle", descKey: "contact.bizDesc", emailKey: "contact.bizEmail" },
  { icon: "pen-tool", color: "#7c3aed", titleKey: "contact.editorialTitle", descKey: "contact.editorialDesc", emailKey: "contact.editorialEmail" },
  { icon: "newspaper", color: "#f59e0b", titleKey: "contact.pressTitle", descKey: "contact.pressDesc", emailKey: "contact.pressEmail" },
];
    ...
    "@graph": [
      {
        ...
        mainEntity: {
          ...
          contactPoint: [
            ...
            { "@type": "ContactPoint", contactType: "editorial", email: "editorial@ratedbrokers.com" },
            { "@type": "ContactPoint", contactType: "press", email: "press@ratedbrokers.com" },
          ],
        },
      },
    ...
    <div style={{ fontFamily: "'DM Sans',system-ui,sans-serif", background: "#f8f9fb", color: "#1e293b", minHeight: "100vh" }}>
      ...
      <section style={{ ...cn, marginBottom: 48 }}>
        <div style={{
          ...
          <IconBox name="timer" color="#059669" size={44} iconSize={22} />
          <div>
