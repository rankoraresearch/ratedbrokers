...
const COMPARISONS = [
  { a: "ic-markets", b: "pepperstone", label: "IC Markets vs Pepperstone" },
  { a: "etoro", b: "plus500", label: "eToro vs Plus500" },
  { a: "charles-schwab", b: "fidelity", label: "Schwab vs Fidelity" },
];
        ...
        <div style={cn}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: mob ? "1fr" : "1fr 1fr 1fr", gap: 10 }}>
            {COMPARISONS.map(c => {
              ...
              if (!a || !b) return null;
              return (
                <Link key={c.label} to={`/compare/${c.a}-vs-${c.b}`} style={{
