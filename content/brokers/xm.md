...
accounts:
  - name: Micro
    ...
    commission: None
    min: 5
    best: "Complete beginners, micro lot trading"
  - name: Standard
    spread: "1.0 pips"
    commission: None
    min: 5
    best: Intermediate traders seeking simplicity
  - name: XM Ultra Low
    spread: "0.6 pips"
    commission: None
    min: 5
...
timeline:
  - year: 2009
    event: "Founded in Limassol, Cyprus as Trading Point of Financial Instruments"
  - year: 2010
    event: "Obtained CySEC regulation, launched first MT4 server"
  - year: 2014
    event: Surpassed 1 million active clients worldwide
  - year: 2016
    event: "Rebranded to XM, obtained ASIC license for Australia"
  - year: 2018
    event: "Launched XM Ultra Low account, expanded to DFSA regulation"
  - year: 2020
    event: "Exceeded 3 million clients, launched educational webinar series"
  - year: 2022
...
pros:
  ...
  - Dual Tier-1 regulation (CySEC + ASIC) with solid safety record
  - Zero commission on all standard account types
  - Industry-leading educational content with daily webinars and research
  - "1:1000 maximum leverage on IFSC entity for experienced traders"
  - Loyalty program with XM Points redeemable for credit bonuses
  - Supports micro lots (0.01) on Micro account for beginners
  - Available in 190+ countries with multilingual 24/5 support
...
faq:
  ...
  - q: "Is XM a market maker?"
    a: "Yes. XM operates a market maker (B-book) model, meaning it may take the opposite side of client trades internally. This is disclosed in their execution policy. While this creates a potential conflict of interest, XM's long track record, Tier-1 regulation, and no-requotes policy provide reasonable confidence in fair execution."
  - q: "How do XM spreads compare to ECN brokers?"
    a: "XM spreads are wider than ECN brokers. EUR/USD averages 0.80 pips on the Ultra Low account versus 0.02 pips at IC Markets. However, XM charges no commission, so the total cost is the spread alone. For traders executing fewer than 5 lots per day, the cost difference is modest."
  - q: "Does XM offer educational content?"
    a: "Yes, and it's among the best in the industry. XM provides daily live webinars in 19 languages, video tutorials, forex education articles, and the XM Research portal with daily technical analysis. The XM educational hub is structured for beginners through advanced traders."
  - q: "Can I trade crypto on XM?"
    a: "Yes. XM offers crypto CFDs including Bitcoin, Ethereum, Litecoin, Ripple, and several altcoins. Crypto trading is available 24/7 with leverage up to 1:250 on the IFSC entity. CySEC and ASIC entities have lower crypto leverage limits due to regulatory requirements."
  - q: "How fast are XM withdrawals?"
    a: "XM processes withdrawal requests within 24 hours. E-wallets (Skrill, Neteller) are typically received the same day. Card withdrawals take 2-5 business days due to card issuer processing. Bank transfers take 3-5 business days. There are no withdrawal fees from XM's side."
  - q: "What is XM's loyalty program?"
...
similar:
  - name: eToro
    ...
    spread: "1.0"
    type: Social Trading
    why: Better for copy trading
    slug: etoro
  - name: Exness
    score: 9.1
    spread: "0.0"
    type: ECN/MM
    why: "Lower spreads, more leverage"
    slug: exness
  - name: AvaTrade
    score: 8.6
    spread: "0.9"
    type: Market Maker
    why: "More platforms, AvaOptions"
    slug: avatrade
